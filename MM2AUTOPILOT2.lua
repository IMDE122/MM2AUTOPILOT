--[[
    ================================================================================
    IMDE HUB V9 — NON-STRICT PRODUCTION RELEASE
    ================================================================================
    [UPGRADES & FIXED IN THIS VERSION]
    1. Lua Standard Mode: Standard Luau code without explicit typing annotations.
    2. Role Resolver System: Real-time detection of Murderer (Knife), Sheriff (Gun),
       and Innocent (No weapons in character or Backpack).
    3. Collection Priority: Auto Collect is forced to HIGHEST priority (overrides Chase/Avoid).
    4. Smart Topology Map Scanner: Asynchronous map scan mapping obstacles and pathways.
    5. Navigation & Pathing: Dynamic path computation, auto-turn on bump, jump assistance,
       stuck recovery, and smooth motion execution.
    ================================================================================
--]]
